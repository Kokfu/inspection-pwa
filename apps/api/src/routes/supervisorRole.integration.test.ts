...
const supervisorReads = new Set([
  ...
  // FM200 postdates T5c (this branch's own system, cloned from CO2 for the client demo);
  // widened the same way as the other 8 V7 systems above (owner decision, merge review).
  "GET /fm200-inspections/:clientUuid",
