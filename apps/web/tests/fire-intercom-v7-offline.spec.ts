...
test("Fire Intercom V7 runs the full offline round trip: draft, reload, sync, accepted photos load", async ({ page }) => {
  await page.goto("/tests/fire-intercom-v7-offline.html");
