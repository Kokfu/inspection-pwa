...
test("Automatic Sprinkler V7 runs the full offline round trip: no PSI control, reload, sync, accepted photos load", async ({ page }) => {
  await page.goto("/tests/automatic-sprinkler-v7-offline.html");
