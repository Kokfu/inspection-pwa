...
test("Hose Reel V7 schema 3 accepted detail renders per-drum type labels and field-owned evidence across checklist, test-run, and drum-row paths", async ({ page }) => {
