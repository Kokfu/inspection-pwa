...
test("Dry/Wet Riser V7 runs the full offline round trip: dedup PSI checklist, reload, sync, accepted photos load", async ({ page }) => {
  await page.goto("/tests/dry-wet-riser-v7-offline.html");
