...
export const implementedSystemKeys = [
  ...
  "smoke_ventilation", "fire_intercom", "fm200_fire_suppression"
] as const;
...
export const v7SharedEvidenceSystemKeys = ["co2_fire_extinguisher", "wet_chemical", "hydrant", "hose_reel", "automatic_sprinkler", "dry_wet_riser", "smoke_ventilation", "fire_intercom", "fm200_fire_suppression"] as const;

// Smoke Ventilation, Fire Intercom and FM200 have no pre-V7 contract (see the
// API's systemContractCompatibility.ts) - their "legacy" version is 7 itself.
const contractVersions: Readonly<Record<ImplementedSystemKey, number>> = {
  ...
  smoke_ventilation: 7, fire_intercom: 7, fm200_fire_suppression: 7
};
