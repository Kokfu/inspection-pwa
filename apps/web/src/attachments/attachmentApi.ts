...
export const v7StagingSystemKeys = ["co2_fire_extinguisher", "wet_chemical", "fire_alarm_detector", "hydrant", "hose_reel", "automatic_sprinkler", "dry_wet_riser", "smoke_ventilation", "fire_intercom"] as const;
