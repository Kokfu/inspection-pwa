...
export async function resolveDryWetRiserRoute(clientUuid: string, authStatus: "verified" | "offline-unverified" | "logged-out", loadServer = loadServerDryWetRiserDetail): Promise<DryWetRiserRouteResolution> {
