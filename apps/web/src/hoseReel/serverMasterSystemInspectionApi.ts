export type ServerMasterSystemInspectionSummary = {
  clientUuid: string;
  jobId: string;
  systemKey: "hose_reel" | "co2_fire_extinguisher" | "wet_chemical" | "automatic_sprinkler" | "dry_wet_riser" | "fire_alarm_detector" | "hydrant" | "portable_fire_extinguisher" | "smoke_ventilation";
  instanceKey: string;
  zoneId: string | null;
  ...
  systemKey: "hose_reel" | "co2_fire_extinguisher" | "wet_chemical" | "dry_wet_riser" | "fire_alarm_detector" | "hydrant" | "portable_fire_extinguisher" | "smoke_ventilation";
});
...
const systemKeys = new Set<ServerMasterSystemInspectionSummary["systemKey"]>(["hose_reel", "co2_fire_extinguisher", "wet_chemical", "automatic_sprinkler", "dry_wet_riser", "fire_alarm_detector", "hydrant", "portable_fire_extinguisher", "smoke_ventilation"]);
